...
const cases = [
  ...
  { img: "/healing-waves-card.png", tag: "HEALTHCARE", industry: "Regenerative Healthcare", title: "Healing Waves", scope: "Website and digital presence for a regenerative expert clinic across Pune locations.", metric: "A Big Wave In Healing Technology", note: "Clinic website + patient communication", stats: [{ v: "3 clinics", l: "Kharadi, Hadapsar, and Pimple Saudagar" }, { v: "e-STARR Protocol", l: "Regenerative therapy positioning" }, { v: "Digital presence", l: "Website and patient journey" }] },
