...
const cases = [
  ...
  { img: "/healing-waves-card.png", tag: "HEALTHCARE", industry: "Regenerative Healthcare", title: "Healing Waves Clinic", scope: "Full-stack marketing concierge for a 4-branch Pune orthopaedic clinic - from zero systems to measurable growth.", metric: "A Big Wave In Healing Technology", note: "Clinic website + patient communication", stats: [{ v: "1,072%*", l: "LinkedIn impression growth in 28 days" }, { v: "e-STARR Protocol", l: "Regenerative therapy positioning" }, { v: "Digital presence", l: "Website and patient journey" }] },
